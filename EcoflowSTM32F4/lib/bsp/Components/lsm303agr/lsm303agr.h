...
/** @defgroup Acc_Full_Scale_Selection
  * @{
  */
#define LSM303AGR_FULLSCALE_2G            ((uint8_t)0x00)  /*!< \xb12 g */
#define LSM303AGR_FULLSCALE_4G            ((uint8_t)0x10)  /*!< \xb14 g */
#define LSM303AGR_FULLSCALE_8G            ((uint8_t)0x20)  /*!< \xb18 g */
#define LSM303AGR_FULLSCALE_16G           ((uint8_t)0x30)  /*!< \xb116 g */
/**
  * @}
  */
...
/** @defgroup Mag_Full_Scale
  * @{
  */
#define  LSM303AGR_FS_1_3_GA               ((uint8_t) 0x20)  /*!< Full scale = \xb11.3 Gauss */
#define  LSM303AGR_FS_1_9_GA               ((uint8_t) 0x40)  /*!< Full scale = \xb11.9 Gauss */
#define  LSM303AGR_FS_2_5_GA               ((uint8_t) 0x60)  /*!< Full scale = \xb12.5 Gauss */
#define  LSM303AGR_FS_4_0_GA               ((uint8_t) 0x80)  /*!< Full scale = \xb14.0 Gauss */
#define  LSM303AGR_FS_4_7_GA               ((uint8_t) 0xA0)  /*!< Full scale = \xb14.7 Gauss */
#define  LSM303AGR_FS_5_6_GA               ((uint8_t) 0xC0)  /*!< Full scale = \xb15.6 Gauss */
#define  LSM303AGR_FS_8_1_GA               ((uint8_t) 0xE0)  /*!< Full scale = \xb18.1 Gauss */
/**
  * @}
  */
