...
*/
#define uECC_set_rng micro_ecc_uECC_set_rng
...
*/
#define uECC_get_rng micro_ecc_uECC_get_rng
...
*/
#define uECC_curve_private_key_size micro_ecc_uECC_curve_private_key_size
...
*/
#define uECC_curve_public_key_size micro_ecc_uECC_curve_public_key_size
...
*/
#define uECC_make_key micro_ecc_uECC_make_key
...
*/
#define uECC_shared_secret micro_ecc_uECC_shared_secret
...
*/
#define uECC_compress micro_ecc_uECC_compress
...
*/
#define uECC_decompress micro_ecc_uECC_decompress
...
*/
#define uECC_valid_public_key micro_ecc_uECC_valid_public_key
...
*/
#define uECC_compute_public_key micro_ecc_uECC_compute_public_key
...
*/
#define uECC_sign micro_ecc_uECC_sign
...
Returns 1 if the signature generated successfully, 0 if an error occurred.
*/
#define uECC_sign_deterministic micro_ecc_uECC_sign_deterministic
...
*/
#define uECC_verify micro_ecc_uECC_verify
