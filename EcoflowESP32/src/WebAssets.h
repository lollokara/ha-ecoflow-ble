    ...
    const renderD3P = (d) => `
        <div class="card ${d.connected?'':'offline'}" id="card-${d.type}">
            ...
            <div class="controls" id="ctrl-${d.type}">
                ...
                <div class="ctrl-row"><span>AC Charge Limit: <b id="val-ac-${d.type}" style="color:var(--neon-cyan)">${d.cfg_ac_lim}</b>W</span></div>
                <input type="range" id="rg-ac-${d.type}" min="400" max="2900" step="100" value="${d.cfg_ac_lim}" onchange="cmd('${d.type}', 'set_ac_lim', parseInt(this.value), this)" oninput="el('val-ac-${d.type}').innerText=this.value">
                ...
                <input type="range" id="rg-bkp-${d.type}" min="0" max="100" value="${d.backup_lvl}" onchange="cmd('${d.type}', 'set_backup_level', parseInt(this.value), this)" oninput="el('val-bkp-${d.type}').innerText=this.value">
